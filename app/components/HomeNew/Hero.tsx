        ...
        <div className='relative'>
            <div className="w-full 1000px:flex items-center bg-[#ebfff3] 1000px:pt-10 ">
                ...
                <div className="pt-50 1000px:w-[60%]  justify-center md:justify-start flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left min-h-[70vh]">
                    <h2 data-aos="fade-up" data-aos-delay="50" className="font-Anuphan text-[#000000c7] text-[30px] px-3 w-full 1000px:text-[50px] font-[600] py-2 1000px:leading-[75px] 1500px:w-[60%] 1100px:w-[78%]">
                    UNLOCK A BETTER <p className='text-[var(--primary-color)] underline'>Thing</p>
                    </h2>
                    <br />
                    <p data-aos="fade-up" data-aos-delay="100" className="text-[#000000ac] font-Anuphan font-[600] text-[18px] 1500px:!w-[55%] 1100px:!w-[78%] p-[10px] md:p-[0px]">
                        {banner?.subTitle}
                    </p>
                    <br />
                    <br />
