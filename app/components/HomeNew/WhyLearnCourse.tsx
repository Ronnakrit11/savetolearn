...
const item = [
    {
        title: ' Learn',
        icon: '/Learn.png',
        message: 'แบ่งปันประสบการณ์จากการเรียนรู้และลงมือทำเฉพาะด้าน',
    },
    {
        title: 'Create',
        icon: '/Create.png',
        message: 'สร้างรายได้จริงในขณะที่กำลังเรียนรู้การใช้เครื่องมือต่างๆของระบบ',
    },
    {
        title: 'Work',
        icon: '/Work.png',
        message: 'สามารถนำไปใช้จริงได้ต่อยอดเป็นอาชีพ',
    },
]
